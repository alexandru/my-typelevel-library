...
function prepareIdxAndDocMap() {
  const docs = [  
    {
      "title": "Change Log",
      "url": "/my-typelevel-library/CHANGELOG.html",
    ...
    } ,    
    {
      ...
      "url": "/my-typelevel-library/CODE_OF_CONDUCT.html",
    ...
    } ,    
    {
      ...
      "url": "/my-typelevel-library/core/example.html",
      "content": "Example Just a sample document. Scala code import cats.implicits._ import my.typelevel.library.Example Example.sumAll(List(1, 2, 3, 4))"
    } ,    
    {
      "title": "Home",
      "url": "/my-typelevel-library/",
      "content": "My Typelevel Library An awesome public FP library. Usage The packages are published on Maven Central. libraryDependencies += \"org.alexn\" %% \"my-typelevel-library-core\" % \"&lt;version&gt;\" Documentation Links: Website API documentation Contributing The My Typelevel Library project welcomes contributions from anybody wishing to participate. All code or documentation that is provided must be licensed with the same license that My Typelevel Library is licensed with (Apache 2.0, see LICENCE). People are expected to follow the Scala Code of Conduct when discussing My Typelevel Library on GitHub, Gitter channel, or other venues. Feel free to open an issue if you notice a bug, have an idea for a feature, or have a question about the code. Pull requests are also gladly accepted. For more information, check out the contributor guide. License All code in this repository is licensed under the Apache License, Version 2.0. See LICENCE."
    } ,        
  ];
