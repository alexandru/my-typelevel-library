...
People are expected to follow the [Scala Code of Conduct](./CODE_OF_CONDUCT.md) when discussing My Typelevel Library on the Github page, Gitter channel, or other venues.
...
```
Copyright (c) $today.year the My Typelevel Library contributors.
